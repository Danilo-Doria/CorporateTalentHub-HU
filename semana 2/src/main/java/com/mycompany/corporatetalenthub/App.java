...
public class App {
                ...
                try {
                    ...
                    switch (opcion) {
                        ...
                        case 4:
                            ...
                            buscarEmpleado(scanner, empleados, cantidadEmpleados);
    ...
    private static boolean registrarEmpleado(
        ...
        empleados[posicion].setPromedioDesempeno(suma/CANTIDAD_TRIMESTRES);
        ...
        for (var indice = 0; indice < cantidadEmpleados; indice++) {
            if (empleados[indice].getId() == idBuscado) {
                System.out.printf("ID: %d | Nombre: %s | Promedio: %.2f | "
                        + "Edad: %d | Salario: %.2f\n",
                        empleados[indice].getId(),
                        empleados[indice].getNombre(),
                        empleados[indice].getPromedioDesempeno(),
                        empleados[indice].getEdad(),
                        empleados[indice].getSalario()
                );
            } else {
